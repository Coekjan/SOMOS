...
#define SYS_wait_cons		((__SYSCALL_BASE ) + 17)
#define SYS_signal_cons		((__SYSCALL_BASE ) + 18)
#define SYS_set_env			((__SYSCALL_BASE ) + 19)
#define SYS_get_env			((__SYSCALL_BASE ) + 20)
#define SYS_list_env_var	((__SYSCALL_BASE ) + 21)
